...
#
#  https://github.com/KhulnaSoft/project-template
#
...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/KhulnaSoft/Template-repo repo && cd repo && make
#
# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/KhulnaSoft/Template-repo repo && cd repo && make
#
# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/KhulnaSoft/Template-repo repo && cd repo && make
...
REPO := KhulnaSoft/project-template
