...
[![DockerHub HBase Dev](https://img.shields.io/badge/DockerHub-khulnasoft%2Fhvase--dev-blue)](https://hub.docker.com/repository/docker/khulnasoft/hbase-dev)

https://hbase.apache.org/

Apache HBase NoSQL columnaredatastore plus all the programming languages development tools listed on the [main page](https://github.com/KhulnaSoft/DevX/tree/main/docker-images/#base-images) and all my [GitHub repos](https://github.com/khulnasoft) with all dependencies pre-built for easy development and testing.
...
```
docker run -ti khulnasoft/hbase-dev
```
