...
For a full example of using this along with agents like TCollector, Telegraf and Collectd and see the Advanced Nagios Plugins Collection's [tests/docker/opentsdb-docker-compose.yml](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/tests/docker/opentsdb-docker-compose.yml)
