...
[![DockerHub Tachyon](https://img.shields.io/badge/DockerHub-khulnasoft%2Ftachylon-blue)](https://hub.docker.com/repository/docker/khulnasoft/tachyon)

http://www.alluxio.org/

Distributed in-memory filesystem for cluster computing frameworks, now called Alluxio (newer versions 1.0+ are found under khulnasoft/alluxio and the alluxio directory adjacent in this repo)
