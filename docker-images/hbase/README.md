...
[![DockerHub HBase](https://img.shields.io/badge/DockerHub-khulnasoft%2Fhbase-blue)](https://hub.docker.com/repository/docker/khulnasoft/hbase)
...
```
docker run -ti khulnasoft/hbase
```
