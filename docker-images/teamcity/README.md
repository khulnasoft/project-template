...
[![DockerHub Teamcity](https://img.shields.io/badge/DockerHub-khulnasoft%2Fteamcity-blue)](https://hub.docker.com/repository/docker/khulnasoft/teamcity)
...
https://github.com/KhulnaSoft/TeamCity-CI
...
- [DevOps Bash tools](https://github.com/KhulnaSoft/DevOps-Bash-tools) - Fully automated builds for Jenkins, Concourse and GoCD along with auto-loaded pipeline build configurations, and API scripts for all major CI systems

- [Templates](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates) - templates for many CI systems, code and configs eg. Jenkinsfile, GitHub Actions, Travis CI, CircleCI, GCP Cloud Build, Makefile, Vagrantfile, Dockerfile, docker-compose.yml etc.

- [Advanced Nagios Plugins](https://github.com/KhulnaSoft/Nagios-Plugins) - 450+ production monitoring checks including for the Jenkins API


### All the CI Systems

All my [major GitHub repos](https://github.com/KhulnaSoft) contain fully working live configs for just about every major CI system out there:
