...
[![DockerHub Hadoop](https://img.shields.io/badge/DockerHub-khulnasoft%2Fhadoop-blue)](https://hub.docker.com/repository/docker/khulnasoft/hadoop)
...
```
docker run -ti -p 8042 -p 8088 -p 19888 -p 50070 -p 50075 khulnasoft/hadoop
```
