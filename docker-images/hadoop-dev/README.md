...
[![DockerHub Hadoop Dev](https://img.shields.io/badge/DockerHub-khulnasoft%2Fhadoop--dev-blue)](https://hub.docker.com/repository/docker/khulnasoft/hadoop-dev)
...
```
docker run -ti -p 8042 -p 8088 -p 19888 -p 9064 -p 9070 khulnasoft/hadoop-dev
```
