...
[![DockerHub FakeS3](https://img.shields.io/badge/DockerHub-khulnasoft%2Ffakes3-blue)](https://hub.docker.com/repository/docker/khulnasoft/fakes3)
...
```
docker run khulnasoft/fakes3 <license_key>
```
