...
[![DockerHub Jenkins Agent](https://img.shields.io/badge/DockerHub-khulnasoft%2Fjenkins--agent--docker-blue)](https://hub.docker.com/repository/docker/khulnasoft/jenkins-agent-docker)
...
```
docker run -ti -u 0 -v /var/run/docker.sock:/var/run/docker.sock khulnasoft/jenkins-agent-docker bash
...
https://github.com/KhulnaSoft/Kubernetes-templates
