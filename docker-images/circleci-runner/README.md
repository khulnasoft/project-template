...
[![DockerHub CircleCI Runner](https://img.shields.io/badge/DockerHub-khulnasoft%2Fcircleci--runner-blue)](https://hub.docker.com/repository/docker/khulnasoft/circleci-runner)

CircleCI self-hosted runner, with added build dependencies eg. make, python3

Usage:
```
docker run -e CIRCLECI_API_TOKEN=... -e CIRCLECI_RESOURCE_CLASS=<namespace>/<resource_class> khulnasoft/circleci-runner
```
