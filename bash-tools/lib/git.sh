...
# shouldn't need to use this any more, git_check_branches_upstream.py from DevOps Python Tools repo has a --fix flag which will do this for all branches if they have no upstream set - https://github.com/KhulnaSoft/DevX/tree/main/tools/python
set_upstream(){
...
azure_to_git_url(){
    ...
    #
    #   git@ssh.dev.azure.com:v3/khulnasoft/GitHub/DevOps-Bash-tools
    #   https://dev.azure.com/khulnasoft/GitHub/_git/DevOps-Bash-tools
    #
