...
# SYSTEM_TASKDEFINITIONSURI=https://dev.azure.com/khulnasoft/
# SYSTEM_TEAMFOUNDATIONCOLLECTIONURI=https://dev.azure.com/khulnasoft/
# SYSTEM_TEAMFOUNDATIONSERVERURI=https://dev.azure.com/khulnasoft/
# TF_BUILD=True
#
is_azure_devops(){
    if is_tfs_ci; then
