...
[![CodeFactor](https://www.codefactor.io/repository/github/khulnasoft/devops-bash-tools/badge)](https://www.codefactor.io/repository/github/khulnasoft/devops-bash-tools)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_DevOps-Bash-tools&metric=alert_status)](https://sonarcloud.io/dashboard?id=KhulnaSoft_DevOps-Bash-tools)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_DevOps-Bash-tools&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_DevOps-Bash-tools)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_DevOps-Bash-tools&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_DevOps-Bash-tools)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_DevOps-Bash-tools&metric=security_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_DevOps-Bash-tools)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_DevOps-Bash-tools&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_DevOps-Bash-tools)
...
[![StarCharts](https://img.shields.io/badge/Star-Charts-blue?logo=github)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/STARCHARTS.md)
...
<!-- TODO: fix
[![DockerHub Build Automated](https://img.shields.io/docker/automated/khulnasoft/bash-tools?logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/bash-tools)
[![Docker Build Status](https://img.shields.io/docker/cloud/build/khulnasoft/bash-tools?logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/bash-tools/builds)
-->
...
[![Build Status](https://badges.herokuapp.com/travis/KhulnaSoft/DevOps-Bash-tools?label=Travis%20CI)](https://travis-ci.org/KhulnaSoft/DevOps-Bash-tools)

awkward URLs more nicely replaced with shields.io

[![AppVeyor](https://ci.appveyor.com/api/projects/status/u6f97cskcgb30sce/branch/master?svg=true)](https://ci.appveyor.com/project/KhulnaSoft/devops-bash-tools/branch/master)
[![Drone](https://cloud.drone.io/api/badges/KhulnaSoft/DevOps-Bash-tools/status.svg)](https://cloud.drone.io/KhulnaSoft/DevOps-Bash-tools)
-->
...
[![Jenkins](https://img.shields.io/badge/Jenkins-ready-blue?logo=jenkins&logoColor=white)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/Jenkinsfile)
[![Concourse](https://img.shields.io/badge/Concourse-ready-blue?logo=concourse&logoColor=white)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/cicd/.concourse.yml)
[![GoCD](https://img.shields.io/badge/GoCD-ready-blue?logo=go&logoColor=white)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/cicd/.gocd.yml)
...
[![Cirrus CI](https://img.shields.io/cirrus/github/KhulnaSoft/DevOps-Bash-tools/master?logo=Cirrus%20CI&label=Cirrus%20CI)](https://cirrus-ci.com/github/KhulnaSoft/DevOps-Bash-tools)
[![Semaphore](https://khulnasoft.semaphoreci.com/badges/DevOps-Bash-tools.svg)](https://khulnasoft.semaphoreci.com/projects/DevOps-Bash-tools)
[![Buddy](https://img.shields.io/badge/Buddy-ready-1A86FD?logo=buddy)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/buddy.yml)
[![Shippable](https://img.shields.io/badge/Shippable-legacy-lightgrey?logo=jfrog&label=Shippable)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/shippable.yml)
[![Travis CI](https://img.shields.io/badge/TravisCI-ready-blue?logo=travis&label=Travis%20CI)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/travis/.travis.yml)
[![Reviewed by Hound](https://img.shields.io/badge/Reviewed%20by-Hound-8E64B0.svg)](https://houndci.com)

[![Repo on GitHub](https://img.shields.io/badge/repo-GitHub-2088FF?logo=github)](https://github.com/khulnasoft/project-template/tree/main/scripts)
[![Repo on GitLab](https://img.shields.io/badge/repo-GitLab-FCA121?logo=gitlab)](https://gitlab.com/KhulnaSoft/DevOps-Bash-tools)
[![Repo on Azure DevOps](https://img.shields.io/badge/repo-Azure%20DevOps-0078D7?logo=azure%20devops)](https://dev.azure.com/khulnasoft/GitHub/_git/DevOps-Bash-tools)
[![Repo on BitBucket](https://img.shields.io/badge/repo-BitBucket-0052CC?logo=bitbucket)](https://bitbucket.org/KhulnaSoft/DevOps-Bash-tools)

[![Azure DevOps Pipeline](https://dev.azure.com/khulnasoft/GitHub/_apis/build/status/KhulnaSoft.DevOps-Bash-tools?branchName=master)](https://dev.azure.com/khulnasoft/GitHub/_build/latest?definitionId=1&branchName=master)
[![GitLab Pipeline](https://img.shields.io/badge/GitLab%20CI-legacy-lightgrey?logo=gitlab)](https://gitlab.com/KhulnaSoft/DevOps-Bash-tools/pipelines)
[![BitBucket Pipeline](https://img.shields.io/badge/Bitbucket%20CI-legacy-lightgrey?logo=bitbucket)](https://bitbucket.org/khulnasoft/devops-bash-tools/addon/pipelines/home#!/)
[![AWS CodeBuild](https://img.shields.io/badge/AWS%20CodeBuild-ready-blue?logo=amazon%20aws)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/cicd/buildspec.yml)
[![GCP Cloud Build](https://img.shields.io/badge/GCP%20Cloud%20Build-ready-blue?logo=google%20cloud&logoColor=white)](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/cicd/cloudbuild.yaml)

[![ShellCheck](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/shellcheck.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/shellcheck.yaml)
[![JSON](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/json.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/json.yaml)
[![YAML](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/yaml.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/yaml.yaml)
[![XML](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/xml.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/xml.yaml)
[![Markdown](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/markdown.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/markdown.yaml)
[![Validation](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/validate.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/validate.yaml)
[![Kics](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/kics.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/kics.yaml)
[![Grype](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/grype.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/grype.yaml)
[![Semgrep](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/semgrep.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/semgrep.yaml)
[![Semgrep Cloud](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/semgrep-cloud.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/semgrep-cloud.yaml)
[![Trivy](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/trivy.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/trivy.yaml)

[![Docker Build (Alpine)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_alpine.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_alpine.yaml)
[![Docker Build (Debian)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_debian.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_debian.yaml)
[![Docker Build (Fedora)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_fedora.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_fedora.yaml)
[![Docker Build (Ubuntu)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_ubuntu.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/docker_bash_ubuntu.yaml)

[![GitHub Actions Ubuntu](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/GitHub%20Actions%20Ubuntu/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22GitHub+Actions+Ubuntu%22)
[![Mac](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac.yaml)
[![Mac 11](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac_11.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac_11.yaml)
[![Mac 12](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac_12.yaml/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions/workflows/mac_12.yaml)
[![Ubuntu](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Ubuntu/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Ubuntu%22)
[![Ubuntu 20.04](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Ubuntu%2020.04/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Ubuntu+20.04%22)
[![Ubuntu 22.04](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Ubuntu%2022.04/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Ubuntu+22.04%22)
[![Debian](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Debian/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Debian%22)
[![Debian 10](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Debian%2010/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Debian+10%22)
[![Debian 11](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Debian%2011/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Debian+11%22)
[![Debian 12](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Debian%2012/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Debian+12%22)
[![Fedora](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Fedora/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Fedora%22)
[![Alpine](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Alpine/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Alpine%22)
[![Alpine 3](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Alpine%203/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Alpine+3%22)

[![Python 3.7](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Python%203.7/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Python+3.7%22)
[![Python 3.8](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Python%203.8/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Python+3.8%22)
[![Python 3.9](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Python%203.9/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Python+3.9%22)
[![Python 3.10](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Python%203.10/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Python+3.10%22)
[![Python 3.11](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Python%203.11/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Python+3.11%22)
<!--
[![Self Hosted](https://github.com/khulnasoft/project-template/tree/main/scripts/workflows/Self%20Hosted/badge.svg)](https://github.com/khulnasoft/project-template/tree/main/scripts/actions?query=workflow%3A%22Self+Hosted%22)
-->
...
Heavily used in many [GitHub repos](https://github.com/search?o=desc&q=user%3Akhulnasoft+type%3Arepository&type=Repositories), dozens of [DockerHub builds](https://hub.docker.com/r/khulnasoft) ([Dockerfiles](https://github.com/KhulnaSoft/DevX/tree/main/docker-images)) and 600+ [CI builds](https://khulnasoft.github.io/CI-CD/).
...
- CI configs for most major Continuous Integration products (see [CI builds](https://khulnasoft.github.io/CI-CD/) page)
- CI scripts for a drop-in framework of standard checks to run in all [CI builds](https://khulnasoft.github.io/CI-CD/), CI detection, accounting for installation differences across CI environments, root vs user, virtualenvs etc.
...
- Utility Libraries used by many hundreds of scripts and [builds](https://khulnasoft.github.io/CI-CD/) across [repos](https://github.com/search?o=desc&q=user%3Akhulnasoft+type%3Arepository&type=Repositories):
  - `.bash.d/` - interactive library
  - `lib/` - scripting and CI library
- [SQL Scripts](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/SQL) - 100+ scripts for [PostgreSQL](https://www.postgresql.org/), [MySQL](https://www.mysql.com/), [AWS Athena](https://aws.amazon.com/athena/) + [CloudTrail](https://aws.amazon.com/cloudtrail/), [Google BigQuery](https://cloud.google.com/bigquery)
- [Templates](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates) - templates for common programming languages and build configs
- [Kubernetes Configs](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes) - Kubernetes YAML configs for most common scenarios, including Production Best Practices, Tips & Tricks

See Also: [similar DevOps repos](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/README.md#see-also) in other languages
...
```shell
git clone https://github.com/khulnasoft/project-template/tree/main/scripts bash-tools
cd bash-tools
make
```
...
- [Databases](#databases) - fast CLI wrappers, instant Docker sandboxes (PostgreSQL, MySQL, MariaDB, SQLite), [SQL scripts](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/SQL), SQL script testers against all versions of a DB, advanced `.psqlrc`
...
- [Templates](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates) - Templates for AWS, GCP, Terraform, Docker, Jenkins, Cloud Build, Vagrant, Puppet, Python, Bash, Go, Perl, Java, Scala, Groovy, Maven, SBT, Gradle, Make, GitHub Actions, CircleCI, Jenkinsfile, Makefile, Dockerfile, docker-compose.yml etc.
- [Kubernetes Configs](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes) - Kubernetes YAML configs for most common scenarios, including Production Best Practices, Tips & Tricks
...
- `.bash.d/*.sh` - thousands of lines of advanced bashrc code, aliases, functions and environment variables for:
  ...
  - and lots more - see [.bash.d/README](https://github.com/khulnasoft/project-template/tree/main/scripts/blob/master/.bash.d/README.md) for a more detailed list
...
- `lib/*.sh` - Bash utility libraries full of functions for
  ...
  Sourced from all my other [GitHub repos](https://github.com/khulnasoft) to make setting up Dockerized tests easier.
...
- `ssl_verify_cert.sh` - verifies a remote SSL certificate (battle tested more feature-rich version `check_ssl_cert.pl` exists in the [Advanced Nagios Plugins](https://github.com/KhulnaSoft/Nagios-Plugins) repo)
...
See also [Knowledge Base notes for Linux](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/linux.md)
and [Mac](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/mac.md).
...
See also [Mac](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/mac.md) page
in [KhulnaSoft/Knowledge-Base](https://github.com/KhulnaSoft/Knowledge-Base).
...
See doc pages in [KhulnaSoft/Knowledge-Base](https://github.com/KhulnaSoft/Knowledge-Base) on Grafana,
...
- [sql/](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/SQL) - 100+ SQL scripts for [PostgreSQL](https://www.postgresql.org/), [MySQL](https://www.mysql.com/), [Google BigQuery](https://cloud.google.com/bigquery) and [AWS Athena](https://aws.amazon.com/athena/) [CloudTrail](https://aws.amazon.com/cloudtrail/) logs integration
...
- `mysql*.sh` - [MySQL](https://www.mysql.com/) scripts:
  ...
  - see also the [SQL Scripts](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/SQL) repo for many more straight MySQL SQL scripts
...
See also [Knowledge Base notes for AWS](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/aws.md).
...
- [Google Cloud](https://cloud.google.com/) scripts - `gcp_*.sh` / `gce_*.sh` / `gke_*.sh` / `gcr_*.sh` / `bigquery_*.sh`:
  ...
  - `gcp_secret*.sh` - Google [Secret Manager](https://cloud.google.com/secret-manager) scripts:
    ...
    - `gcp_secrets_to_kubernetes.sh` - loads GCP secrets to Kubernetes secrets in a 1-to-1 mapping. Can specify a list of secrets or auto-loads all GCP secrets with labels `kubernetes-cluster` and `kubernetes-namespace` matching the current `kubectl` context (`kcd` to the right namespace first, see `.bash.d/kubernetes`). See also `kubernetes_get_secret_values.sh` to debug the actual values that got loaded. See also [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) / [External Secrets](https://external-secrets.io/) in my [Kubernetes repo](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes)
    - `gcp_secrets_to_kubernetes_multipart.sh` - creates a Kubernetes secret from multiple GCP secrets (used to put `private.pem` and `public.pem` into the same secret to appear as files on volume mounts for apps in pods to use). See also [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) / [External Secrets](https://external-secrets.io/) in my [Kubernetes repo](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes)
  ...
  - `gcr_*.sh` - Google [Container Registry](https://cloud.google.com/container-registry) scripts:
    ...
    - see also [cloudbuild.yaml](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates/blob/master/cloudbuild.yaml) in the [Templates](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates) repo
  ...
  - `gcp_cloud_schedule_sql_exports.sh` - creates Google [Cloud Scheduler](https://cloud.google.com/scheduler) jobs to trigger a [Cloud Function](https://cloud.google.com/functions) via [PubSub](https://cloud.google.com/pubsub) to run [Cloud SQL](https://cloud.google.com/sql) exports to [GCS](https://cloud.google.com/storage) for all [Cloud SQL](https://cloud.google.com/sql) instances in the current GCP project
    - the Python [GCF](https://cloud.google.com/functions) function is in the [DevOps Python tools](https://github.com/KhulnaSoft/DevX/tree/main/tools/python) repo
  - `bigquery_*.sh` - [BigQuery](https://cloud.google.com/bigquery) scripts:
    ...
    - see also the [SQL Scripts](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/SQL) repo for many more straight BigQuery SQL scripts
...
See also [Knowledge Base notes for GCP](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/gcp.md).
...
- `kubeadm_join_cmd.sh` - outputs `kubeadm join` command (generates new token) to join an existing Kubernetes cluster (used in [vagrant kubernetes](https://github.com/khulnasoft/project-template/tree/main/scripts/tree/master/vagrant/kubernetes) provisioning scripts)
...
- see also Google Kubernetes Engine scripts in the [GCP - Google Cloud Platform](https://github.com/khulnasoft/project-template/tree/main/scripts/#gcp---google-cloud-platform) section above
- see also the [Kubernetes configs](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes) repo

See also [Knowledge Base notes for Kubernetes](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/kubernetes.md).
...
- `docker_*.sh` / `dockerhub_*.sh` - [Docker](https://www.docker.com/) / [DockerHub](https://hub.docker.com/) API scripts:
  ...
  - `dockerhub_list_tags.sh` - lists tags for a given DockerHub repo. See also [dockerhub_show_tags.py](https://github.com/KhulnaSoft/DevX/tree/main/tools/python/blob/master/dockerhub_show_tags.py) in the [DevOps Python tools](https://github.com/KhulnaSoft/DevX/tree/main/tools/python) repo.
  ...
  - see also the [Dockerfiles](https://github.com/KhulnaSoft/DevX/tree/main/docker-images) repo
- `quay_api.sh` - queries the [Quay.io](https://quay.io/) API with OAuth2 authentication token `$QUAY_TOKEN`

See also [Knowledge Base notes for Docker](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/docker.md).
...
- Data format validation `validate_*.py` from [DevOps Python Tools repo](https://github.com/KhulnaSoft/DevX/tree/main/tools/python):
...
See also [Knowledge Base notes for Hadoop](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/hadoop.md).
...
- `git/*.sh` - [Git](https://git-scm.com/) scripts:
  ...
  - `git_branch_delete_squash_merged.sh` - carefully detects if a squash merged branch you want to delete has no changes with the default trunk branch before deleting it.
     See [Squash Merges](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/git.md#squash-merges-require-force-deleting-branches) in knowledge-base about why this is necessary.
  ...
  - `git_foreach_branch.sh` - executes a command on all branches (useful in heavily version branched repos like in my [Dockerfiles](https://github.com/KhulnaSoft/DevX/tree/main/docker-images) repo)
  ...
  - `git_merge_all.sh` / `git_merge_master.sh` / `git_merge_master_pull.sh` - merges updates from master branch to all other branches to avoid drift on longer lived feature branches / version branches (eg. [Dockerfiles](https://github.com/KhulnaSoft/DevX/tree/main/docker-images) repo)
...
- `github/*.sh` - [GitHub](https://github.com/) API / CLI scripts:
  ...
  - `github_generate_status_page.sh` - generates a [STATUS.md](https://khulnasoft.github.io/CI-CD/) page by merging all the README.md headers for all of a user's non-forked GitHub repos or a given list of any repos etc.
...
See also [Knowledge Base notes for Git](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/git.md).
...
- `jenkins/*.sh` - [Jenkins CI](https://jenkins.io/) scripts:
  ...
  - `jenkins_cli.sh` - shortens `jenkins-cli.jar` command by auto-inferring basic configuations, auto-downloading the CLI if absent, inferrings a bunch of Jenkins related variables like `$JENKINS_URL`, `$JENKINS_CLI_ARGS` and authentication using `$JENKINS_USER`/`$JENKINS_PASSWORD`, or finds admin password from inside local docker container. Used heavily by `jenkins.sh` one-shot setup and the following scripts:
    ...
    - `jenkins_create_job_parallel_test_runs.sh` - creates a freestyle parameterized test sleep job and launches N parallel runs of it to test scaling and parallelization of [Jenkins on Kubernetes](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes#jenkins-on-kubernetes) agents
  ...
  - `jenkins_plugins_latest_versions.sh` - finds the latest versions of given Jenkins plugins. Useful to programmatically upgrade your Jenkins on Kubernetes plugins defined in [values.yaml](https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/kubernetes/blob/6d9e34b74d3fa8f353b0fe56e74cea3af439e01a/jenkins/base/values.yaml#L145)
  - `check_jenkinsfiles.sh` - validates all `*Jenkinsfile*` files in the given directory trees using the online Jenkins validator
  - See also [Knowledge Base notes for Jenkins](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/jenkins.md).
- `teamcity/*.sh` - [TeamCity CI](https://www.jetbrains.com/teamcity/) scripts:
  - `teamcity.sh` - one-touch [TeamCity CI](https://www.jetbrains.com/teamcity/) cluster:
    ...
    - see also: [TeamCity CI](https://github.com/KhulnaSoft/TeamCity-CI) config repo for importing pipelines
...
- `terraform_*.sh` - [Terraform](https://www.terraform.io/) scripts:
  ...
  - See also [Knowledge Base notes for Terraform](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/terraform.md).
...
See also [Knowledge Base notes for CI/CD](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/ci-cd.md).
...
See also [Knowledge Base notes for Java](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/java.md)
and [JVM Performance Tuning](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/java-jvm-performance-tuning.md).
...
- `python_pip_install_for_script.sh` - installs PyPI modules for given script(s) if not already installed. Used for dynamic individual script dependency installation in the [DevOps Python tools](https://github.com/KhulnaSoft/DevX/tree/main/tools/python) repo
...
See also [Knowledge Base notes for Python](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/python.md).
...
See also [Knowledge Base notes for Perl](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/perl.md).
...
See also [Knowledge Base notes for MultiMedia](https://github.com/KhulnaSoft/Knowledge-Base/blob/main/multimedia.md).

### Spotify

40+ [Spotify](https://www.spotify.com/) API scripts (used extensively to manage my [Spotify-Playlists](https://github.com/KhulnaSoft/Spotify-Playlists) repo).
...
- `check_*.sh` - extensive collection of generalized tests - these run against all my GitHub repos via [CI](https://khulnasoft.github.io/CI-CD/). Some examples:
...
> make help
 ...
 Usage:
  ...
  Repo specific options:
    ...
    make ccmenu                 installs and (re)configures CCMenu to watch this and all other major KhulnaSoft GitHub repos
...
[![Star History Chart](https://api.star-history.com/svg?repos=KhulnaSoft/DevOps-Bash-tools&type=Date)](https://star-history.com/#KhulnaSoft/DevOps-Bash-tools&Date)
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=KhulnaSoft&repo=DevOps-Bash-tools&theme=ambient_gradient&description_lines_count=3)](https://github.com/khulnasoft/project-template/tree/main/scripts)
