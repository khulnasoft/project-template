...
#
#  https://github.com/KhulnaSoft/Spotify-Playlists
#
...
Useful for chaining with other 'spotify_*_uri.sh' tools (eg. spotify_playlist_tracks_uri.sh, spotify_search_uri.sh) or loading from saved spotify format playlists (eg. KhulnaSoft/Spotify-Playlists github repo)
