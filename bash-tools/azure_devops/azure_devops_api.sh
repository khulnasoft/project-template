...
#
#  https://azure_devops.com/khulnasoft/bash-tools
#
...
# List a user or organization's Azure DevOps repos:
    ...
    ${0##*/} /khulnasoft/GitHub/_apis/git/repositories  | jq .
...
# List a user or organization's Azure DevOps Pipelines:
    ...
    ${0##*/} /khulnasoft/GitHub/_apis/pipelines | jq .
...
# Get a specific pipeline (has an href to the build yaml):
    ...
    ${0##*/} /khulnasoft/GitHub/_apis/pipelines/1 | jq .
