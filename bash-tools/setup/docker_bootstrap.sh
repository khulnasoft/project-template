...
# Alpine / Wget:
#
#   wget -O- https://raw.githubusercontent.com/KhulnaSoft/DevOps-Bash-tools/master/setup/docker_bootstrap.sh | sh
#
# Curl:
#
#   curl https://raw.githubusercontent.com/KhulnaSoft/DevOps-Bash-tools/master/setup/docker_bootstrap.sh | sh
...
#curl -sSf "https://raw.githubusercontent.com/KhulnaSoft/$repo/master/setup/bootstrap.sh" | sh

trap 'command rm -fv -- /bootstrap.sh /clean_caches.sh' INT QUIT TRAP ABRT TERM EXIT

curl -sSf "https://raw.githubusercontent.com/KhulnaSoft/$repo/master/setup/bootstrap.sh" > /bootstrap.sh
...
curl -sSf https://raw.githubusercontent.com/KhulnaSoft/DevOps-Bash-tools/master/bin/clean_caches.sh > /clean_caches.sh
