...
#  args: github/KhulnaSoft/DevOps-Bash-tools haritest=stuff
#
...
Examples:
    ...
    ${0##*/} github/KhulnaSoft/DevOps-Bash-tools AWS_ACCESS_KEY_ID=AKIA...

    echo AWS_ACCESS_KEY_ID=AKIA... | ${0##*/} github/KhulnaSoft/DevOps-Bash-tools


    Loads both AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY via stdin:

        aws_csv_creds.sh credentials_exported.csv | ${0##*/} github/KhulnaSoft/DevOps-Bash-tools
"
