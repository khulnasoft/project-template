...
# Get a project:
    ...
    ${0##*/} /project/github/KhulnaSoft/DevOps-Bash-tools | jq .
...
# Get a list of pipeline runs for a project:
    ...
    ${0##*/} /project/github/KhulnaSoft/DevOps-Bash-tools/pipeline | jq .

    # just the pipelines triggered by you

    ${0##*/} /project/<vcs>/<user_or_org>/<repo>/pipeline/mine

    ${0##*/} /project/github/KhulnaSoft/DevOps-Bash-tools/pipeline/mine | jq .
...
# Get environment variables for a project (see circleci_project_set_env_vars.sh to easily set them):
    ...
    ${0##*/} /project/github/KhulnaSoft/DevOps-Bash-tools/envvar | jq .
...
# Create / replace a project environment variable:
    ...
    ${0##*/} /project/github/KhulnaSoft/DevOps-Bash-tools/envvar -X POST -d '{\"name\": \"AWS_ACCESS_KEY_ID\", \"value\": \"AKIA...\"}' | jq .
...
#                                                                  eg. https://app.circleci.com/settings/organization/github/KhulnaSoft/contexts
