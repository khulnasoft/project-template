...
Examples:
    ...
    With arguments will query those repo's README.md at the top level - if omitting the owner prefix will prepend \$GITHUB_ORGANIZATION/ or \$GITHUB_USER/
        ...
        GITHUB_USER=KhulnaSoft ./github_generate_status_page.sh  DevOps-Python-tools  DevOps-Perl-tools SomeOtherCoolGuy/his-repo

        GITHUB_ORGANIZATION=my-org ./github_generate_status_page.sh  KhulnaSoft/DevX/tree/main/tools/python  some-org-repo
...
get_repos(){
    ...
    while true; do
        ...
        # eg. CURL_OPTS="-u khulnasoft:$GITHUB_TOKEN" ...
        if [ -z "$(jq '.[]' <<< "$output")" ]; then
            break
...
if is_owner_khulnasoft; then
    cat >> "$tempfile_summary" <<EOF
[![Generate README](https://github.com/KhulnaSoft/CI-CD/actions/workflows/readme.yaml/badge.svg)](https://github.com/KhulnaSoft/CI-CD/actions/workflows/readme.yaml)
[![pages-build-deployment](https://github.com/KhulnaSoft/CI-CD/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/KhulnaSoft/CI-CD/actions/workflows/pages/pages-build-deployment)
[![Netlify Status](https://api.netlify.com/api/v1/badges/853ef60c-c01b-4b83-99ba-8fda541f850f/deploy-status)](https://app.netlify.com/sites/khulnasoft/deploys)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/KhulnaSoft/CI-CD?logo=github)](https://github.com/KhulnaSoft/CI-CD/commits/master)
EOF
fi
...
[![GitHub Pages](https://img.shields.io/badge/GitHub-Pages-2088FF?logo=github)](https://khulnasoft.github.io/CI-CD/)
[![Netlify](https://img.shields.io/badge/Netlify-site-00C7B7?logo=netlify)](https://khulnasoft.netlify.app/)

[![CI/CD Builds](https://img.shields.io/badge/CI%2FCD%20Builds-$num_builds-blue?logo=circleci)](https://khulnasoft.github.io/CI-CD/)
...
#    cat <<EOF
#
#[git.io/hari-ci](https://git.io/hari-ci) generated by \`${0##*/}\` in [KhulnaSoft/DevOps-Bash-tools](https://github.com/khulnasoft/project-template/tree/main/scripts)
#
#This page usually loads better on [BitBucket](https://bitbucket.org/khulnasoft/ci-cd/src/master/README.md) due to less aggressive proxy timeouts cutting off badge loading than GitHub / GitLab
#
#EOF
#
#fi
