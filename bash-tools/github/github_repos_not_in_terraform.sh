...
for repo in $repos; do
    ...
    # but if using a module such as github_repo (https://github.com/KhulnaSoft/Terraform) then need to find names in a repos.tf file, not very portable, may need tuning if you do something different
