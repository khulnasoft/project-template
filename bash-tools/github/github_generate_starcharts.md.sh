...
# Examples:
    ...
    Without arguments queries for all non-fork repos for your \$GITHUB_USER and iterate them up to $top_N to generate the page
        ...
        GITHUB_USER=KhulnaSoft ./github_generate_status_page.sh
"
...
followers="$("$srcdir/github_api.sh" /users/khulnasoft | jq -r .followers)"
...
[git.io/hari-starcharts](https://git.io/hari-starcharts) generated by \`${0##*/}\` in [KhulnaSoft/DevOps-Bash-tools](https://github.com/khulnasoft/project-template/tree/main/scripts)
