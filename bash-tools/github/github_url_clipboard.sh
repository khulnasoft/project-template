...
Designed to quickly and easily copy link content into KhulnaSoft/Knowledge-Base repo
eg. for KhulnaSoft/DevX/tree/main/bash-tools/SQL references to be easily copyable code blocks without having to follow links
