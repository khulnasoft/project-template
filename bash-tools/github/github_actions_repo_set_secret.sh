...
#  args: khulnasoft/devops-bash-tools haritest=stuff haritest2=stuff2
#
...
Examples:
    ...
    ${0##*/} KhulnaSoft/DevOps-Bash-tools AWS_ACCESS_KEY_ID=AKIA...

    echo AWS_ACCESS_KEY_ID=AKIA... | ${0##*/} KhulnaSoft/DevOps-Bash-tools

    echo AWS_ACCESS_KEY_ID=AKIA... | gh secret set -R KhulnaSoft/DevOps-Bash-tools -f -


    Loads both AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY via stdin:

        aws_csv_creds.sh credentials_exported.csv | ${0##*/} KhulnaSoft/DevOps-Bash-tools

        aws_csv_creds.sh credentials_exported.csv | gh secret set -R KhulnaSoft/DevOps-Bash-tools -f -
