...
#  args: /user | jq .
#  args: /users/KhulnaSoft/repos | jq .
#  args: /repos/KhulnaSoft/DevOps-Bash-tools/actions/workflows | jq.
...
# Get the GitHub Actions workflows for a given repo:
    ...
    ${0##*/} /repos/KhulnaSoft/DevOps-Bash-tools/actions/workflows
