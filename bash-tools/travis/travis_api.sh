...
#
#  https://travis.com/khulnasoft/bash-tools
#
...
# Get crons (repository slug must be url-encoded replacing slash with %2F):
    ...
    ${0##*/} /repo/KhulnaSoft%2FDevOps-Bash-tools/crons
...
# Get repository settings:
    ...
    ${0##*/} /repo/KhulnaSoft%2FDevOps-Bash-tools/settings
...
# List caches for a repository:
    ...
    ${0##*/} /repo/KhulnaSoft%2FDevOps-Bash-tools/caches
...
# List environment variables for a repository:
    ...
    ${0##*/} /repo/KhulnaSoft%2FDevOps-Bash-tools/env_vars
"
