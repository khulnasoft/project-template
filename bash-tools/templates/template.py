...
try:
    ...
    from khulnasoft.utils import log
    #from khulnasoft.utils import CriticalError, UnknownError
    from khulnasoft.utils import validate_host, validate_port, validate_user, validate_password
    from khulnasoft.utils import isStr
    from khulnasoft import CLI
    from khulnasoft import RestNagiosPlugin
