...
#
#  [% URL # https://github.com/KhulnaSoft/DevX/tree/main/bash-tools/templates %]
#
...
# Examples:
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code
#
#   https://diagrams.mingrammer.com/docs/getting-started/examples
...
with Diagram('[% NAME %]',
    ...
    #
    #   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/aws_load_balanced_web_farm.py
    #
...
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/aws_web_service_db_cluster.py
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/aws_clustered_web_services.py
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/gcp_pubsub_analytics.py
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/kubernetes_deployment_hpa_ingress.py
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/kubernetes_stateful_architecture.py
#
# Nested Clusters:
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/aws_event_processing.py
...
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/advanced_web_services_open_source.py

# ============================================================================ #
# Download an image to be used in a Custom node
#
#   https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/rabbitmq_broker_with_custom_icon.py
#
