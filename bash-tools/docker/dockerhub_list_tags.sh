...
- dockerhub_show_tags.py in the DevOps Python tools repo:  https://github.com/KhulnaSoft/DevX/tree/main/tools/python

    ddockerhub_show_tags.py khulnasoft/hbase

- Skopeo

    skopeo inspect docker://khulnasoft/hbase | jq -r '.RepoTags[]'
"
