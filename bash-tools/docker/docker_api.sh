...
#  args: https://hub.docker.com/v2/repositories/khulnasoft/hbase/tags | jq .
#
...
# Get all the tags for a given repository called 'khulnasoft/hbase' on DockerHub's public registry:

    ${0##*/} https://hub.docker.com/v2/repositories/khulnasoft/hbase/tags
