...
check_duplicate_email_prefixes(){
    ...
    # email prefixes normalize hari.sekhon => khulnasoft since email accounts like gmail treat them the same, so remember duplicates for khulnasoft may include hari.sekhon
