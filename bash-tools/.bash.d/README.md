...
More script related functions can be found in the [lib/](https://github.com/khulnasoft/project-template/tree/main/scripts/tree/master/lib) directory at the top level.
