...
https://github.com/KhulnaSoft/Jenkins#readme

and specifically:

https://github.com/KhulnaSoft/Jenkins/blob/master/Jenkinsfile

and `trivy*.groovy` under:

https://github.com/KhulnaSoft/Jenkins/tree/master/vars
