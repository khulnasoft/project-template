...
#
#  https://github.com/KhulnaSoft/DevX/tree/main/tools/golang
#
...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/KhulnaSoft/DevX/tree/main/tools/golang go-tools && cd go-tools && make
#
# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/KhulnaSoft/DevX/tree/main/tools/golang go-tools && cd go-tools && make
#
# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/KhulnaSoft/DevX/tree/main/tools/golang go-tools && cd go-tools && make
...
REPO := KhulnaSoft/DevX/tree/main/tools/golang
