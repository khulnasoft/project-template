...
Mainly written for my https://github.com/KhulnaSoft/DevX/tree/main/docker-images repo
...
try:
    ...
    from khulnasoft.utils import die, ERRORS, find_git_root, log, log_option, uniq_list_ordered, validate_regex
