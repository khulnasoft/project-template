...
See also:
    ...
    aws_users_access_key_age.sh - simpler version in the adjacent DevOps Bash Tools repo without age filtering
                                - https://github.com/KhulnaSoft/DevOps-Bash-tools

Advanced Nagios Plugins (https://github.com/KhulnaSoft/Nagios-Plugins)
...
try:
    ...
    from khulnasoft.utils import log, validate_float
