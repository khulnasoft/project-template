...
try:
    ...
    from khulnasoft.utils import prog, log, support_msg_api, jsonpp, qquit, isInt, isStr
    from khulnasoft.utils import CriticalError, UnknownError, code_error
    from khulnasoft.utils import validate_chars, validate_alnum, host_regex
...
class TravisDebugSession(CLI):
    ...
    def process_options(self):
        ...
        if self.args:
            # assume arg is a repo in form of KhulnaSoft/Nagios-Plugins but do not use url which we are more likely to
