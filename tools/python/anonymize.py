...
#
#  ported from Perl version from DevOps Perl Tools repo (https://github.com/KhulnaSoft/DevOps-Perl-tools)
#
...
Based on Perl Anonymize.pl from https://github.com/KhulnaSoft/DevOps-Perl-tools
