...
try:
    ...
    # import khulnasoft.utils
    from khulnasoft.utils import log, InvalidOptionException, qquit, die
    from khulnasoft.utils import validate_file, validate_dirname, validate_host, validate_port, validate_user, \
        validate_password
    from khulnasoft.utils import isStr, isHost, isPort, isUser, isDirname, isJson, jsonpp, list_sort_dicts_by_value
