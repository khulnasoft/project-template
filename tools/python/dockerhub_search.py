...
in the DevOps Bash tools repo - https://github.com/KhulnaSoft/DevX/tree/main/tools/python
...
try:
    ...
    from khulnasoft.utils import log, die, prog, isJson, jsonpp, isInt, validate_int, support_msg_api
