...
try:
    ...
    from khulnasoft.utils import isLinux, isMac, isIP, isPythonMinVersion, ERRORS, printerr, warn, pyspark_path
...
if len(sys.argv) > 1:
    printerr("""KhulnaSoft Ltd - https://github.com/KhulnaSoft/DevX/tree/main/tools/python
