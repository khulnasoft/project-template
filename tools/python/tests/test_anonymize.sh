...
# LDAP too many tests!!
src[50]="CN=KhulnaSoft Ltd,OU=MyOU,DC=MyDomain,DC=com"
...
src[53]="dn: CN=KhulnaSoft Ltd,OU=My OU,DC=MyDomain,DC=com"
#dest[53]="dn: CN=<cn>,OU=<ou>,DC=<dc>,DC=<dc>"
dest[53]="dn: <dn>"

src[54]="cn: KhulnaSoft Ltd"
dest[54]="cn: <cn>"
...
src[59]="distinguishedName: CN=KhulnaSoft Ltd,OU=MyOU,DC=MyDomain,DC=com"
...
src[76]="member: CN=KhulnaSoft Ltd,OU=MyOU,DC=MyDomain,DC=com"
...
src[81]="https://mylonggithubtoken@github.com/khulnasoft/nagios-plugins"
